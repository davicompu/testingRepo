define(['datamodels/user.model', 'services/contexthelper'],
    function (model, contextHelper) {
        ...
        function getItem(id, itemObservable, errorObservable) {
            return contextHelper.ajaxRequest('get', itemApi('getbyid', id))
                .done(getSucceeded)
                .fail(getFailed);
        ...
        // Routes.
        function itemApi(action, id) { return "/api/user/" + action + "/" + (id || ""); }
        //#endregion
    });